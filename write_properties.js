...
export default function Properties() {
  ...
  async function handleSubmit() {
    if (!form.name || !form.address || !form.rent) return alert('\u8acb\u586b\u5beb\u623f\u9593\u540d\u7a31\u3001\u5730\u5740\u548c\u租\u91d1')
    if (editId) {
  ...
  return (
    <div>
      ...
      {showForm && (
        <div style={cardStyle}>
          ...
          <div style={grid2}>
            ...
            <div>
              <label style={labelStyle}>\u6708\u租\u91d1\uff08\u5143\uff09*</label>
          ...
          <div style={grid2}>
            ...
            <div>
              <label style={labelStyle}>\u租\u91d1\u9810\u7b97</label>
      ...
      {loading ? <p>\u8f09\u5165\u4e2d...</p> : list.length === 0 ? (
        <p style={{ color: '#6b7280' }}>\u5c1a\u672a\u65b0\u589e\u4efb\u4f55\u623f\u6e90\uff0c\u9ede\u64ca\u300c\u65b0\u589e\u623f\u6e90\u300d\u958b\u59cb\u4f7f\u7528\u3002</p>
      ) : (
          ...
          {list.map(item => (
            <div key={item.id} style={cardStyle}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                ...
                <span style={{ padding: '2px 10px', borderRadius: '20px', fontSize: '12px', background: item.status === '\u5df2\u租' ? '#dcfce7' : '#fef9c3', color: item.status === '\u5df2\u租' ? '#166534' : '#854d0e' }}>{item.status}</span>
              </div>
